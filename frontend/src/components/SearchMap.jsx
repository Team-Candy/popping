...
const initializeMap = async (region = "seoul", location) => {
  ...
  window.kakao.maps.load(() => {
    ...
    location.forEach(async (item, index) => {
...
//   if (cachedCoords && cachedCoords[region]) {
//     return cachedCoords[region]; // 로컬 스토리지에서 좌표 반환
//   } else if (regionCoordinates[region]) {
//     return regionCoordinates[region];
//   } else {
//     const coords = await fetchLatLng(region);
//     cachedCoords[region] = coords;
